...
class _CommunityPageState extends State<CommunityPage> {
  int _currentIndex = 2; // Set the index to 2 for the "Community" tab
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(
        ...
        alignTitleLeft: true, // Set to true to left-align the title
      ),
      body: ListView(
      ...
      bottomNavigationBar: CustomNavBar(
        ...
        onTap: (index) {
          if (index == 0) {
            Navigator.pushReplacementNamed(context, '/'); // Pop the CommunityPage off the stack
          } else {
            setState(() {
              _currentIndex = index;
            });
